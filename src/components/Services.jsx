        ...
        <div className="grid gap-5 md:grid-cols-3 lg:grid-cols-4">
          {SERVICES.map((svc, i) => (
            <Reveal key={svc.tag} delay={(i % 4) * 40}>
              <div className="group flex h-full flex-col gap-2.5 rounded-[10px] border border-gold/22 bg-linear-160 from-card to-[#0a0c12] px-6 py-[26px] transition-[border-color,transform,box-shadow] duration-250 hover:-translate-y-[3px] hover:border-gold/60 hover:shadow-[0_14px_40px_rgba(212,175,55,.14)]">
