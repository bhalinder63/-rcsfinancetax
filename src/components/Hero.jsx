      ...
      <div className="mx-auto grid w-full max-w-[1440px] items-center gap-6 md:gap-10 lg:grid-cols-[1.15fr_1fr]">
        <div>
          <div className="mb-5 flex items-center gap-3.5">
            <span className="h-px w-11 bg-linear-to-r from-gold to-transparent" />
            <span className="text-sm font-medium tracking-[3.5px] text-gold-bright">
              YOUR TRUSTED PARTNER IN
            </span>
          </div>
          <h1 className="mb-[22px] font-display text-[clamp(36px,4.5vw,58px)] font-bold leading-[1.12]">
          ...
          <p className="mb-[34px] max-w-[520px] text-base leading-[1.65] text-muted [text-wrap:pretty] md:text-lg">
          ...
          <div className="mb-11 flex flex-wrap gap-[18px]">
          ...
          <div className="flex flex-wrap gap-x-[34px] gap-y-5">
        ...
        <div className="relative flex min-h-[320px] items-center justify-center md:min-h-[380px] lg:min-h-[440px]">
          <div className="absolute size-[480px] max-w-full animate-glow rounded-full bg-[radial-gradient(circle,rgba(212,175,55,.22)_0%,transparent_65%)]" />
          <div className="relative flex flex-col items-center gap-[18px] rounded-[14px] border border-gold/35 bg-linear-160 from-[rgba(20,24,36,.9)] to-[rgba(10,12,18,.95)] px-7 pb-[26px] pt-8 shadow-[0_30px_80px_rgba(0,0,0,.6),inset_0_1px_0_rgba(212,175,55,.2)] md:px-14 md:pb-9 md:pt-11">
            <img
              src={logoIcon}
              alt="RCS crest"
              width="490"
