export const CONTACT = {
  address: 'Dharipur, Loni, Ghaziabad, Uttar Pradesh',
  addressLines: ['Dharipur, Loni,', 'Ghaziabad, Uttar Pradesh'],
  hours: 'Mon – Sat · 10:00 AM – 7:00 PM',
  phone: '+91 9999 000 999',
  phoneHref: 'tel:+919999000999',
  email: 'info@rcsfinancetax.com',
  website: 'www.rcsfinancetax.com',
  whatsapp: 'https://wa.me/919999000999',
}
...
export const NAV_LINKS = [
  ...
  { label: 'Why RCS', href: '#why' },
  { label: 'Contact Us', href: '#contact' },
]

export const TRUST_ITEMS = [
  { title: 'Expert Team', sub: 'Experienced professionals' },
  { title: '100% Compliance', sub: 'Secure & accurate' },
  { title: 'Confidential', sub: 'Your data, our priority' },
]
...
export const STATS = [
  ...
  { value: '100%', label: 'Trust & Transparency' },
]
